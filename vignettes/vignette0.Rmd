...
```
progression will be defined as a worsening of either 4 SDMT points or 20% of the reference SDMT value. Alternatively, a custom `delta_fun` can be provided. To change the minimum $\delta$ for SDMT to, say, "either 4 points or 20% of the reference value", we would define:
```{r}
