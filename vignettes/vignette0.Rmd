...
```
    where: `event_sequence`[^seq] specifies the order of the events; the other columns count the events of each kind (improvement; progression; relapse-associated worsening, [RAW](#raw); progression independent of relapse activity, [PIRA](#pira); and progression that could not be classified as either RAW of PIRA with the available information). See [@lublin2014; @kappos2018; @silent2019].
