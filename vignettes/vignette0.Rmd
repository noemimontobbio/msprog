...
> 
> In a multiple-event setting (`event="multiple2`), more than one event per subject can be detected, and `event_count` also includes the event sequence for each subject. See [the relevant section](#multiple).
