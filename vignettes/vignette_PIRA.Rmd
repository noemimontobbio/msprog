...
or (iii) the last visit before event onset with a clinically meaningful score distance from it (`i` such that `outcome[event] - outcome[i] >= delta_fun(outcome[i])`)[^extrema];
