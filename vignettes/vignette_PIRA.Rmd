...
1. Roving baseline, and absence of relapses during the 90 days before and 30 days after the event, and during the 90 days before and 30 days after the confirmation @muller2023:
```{r, indent="    "}
...
2. Post-relapse re-baseline, and absence of relapses between the reference visit and 30 days after the event, and during the 30 days before and 30 days after the confirmation @kappos2020:
```{r, indent="    "}
output <- MSprog(toydata_visits, 'id', 'EDSS', 'date', 'edss',
               relapse=toydata_relapses,
               conf_days=c(7*12, 7*24), conf_tol_days=c(0, Inf), 
