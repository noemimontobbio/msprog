...
The package can be run locally on any computer with R version $\geq$ 3.5.0 (see installation instructions below), or online via a [web application](https://msprog.shinyapps.io/msprog/) with a user-friendly graphical interface.
