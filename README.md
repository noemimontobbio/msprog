...
2.  Extended info on each event for all subjects:
    ...
    #>  id nevent event_type time2event bl2event conf12 sust_days sust_last
    #>   1      1       PIRA        443      443      1         0         1
    ...
    for which the event was sustained *after confirmation*; `sust_last`
